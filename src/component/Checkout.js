                          ...
                          <div className="checkoutinfo orderSummary">
                            {/* {checkOutData.map((item, index) => (
                              ...
                              <div className="checkoutInfo_img">
                                ...
                                <img src={(finItem?.images?.length > 0 && finItem?.images[0]?.image_url) || "false"} className="img-fluid" onError={e => { e.currentTarget.src = require('../public/No_Image_Available.jpeg') }} />
                                </div>
                              <span>+10 Items</span>
                              </div>
